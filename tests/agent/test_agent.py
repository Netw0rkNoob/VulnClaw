...
class TestPromptBuilder:
    ...
    def test_methodology_not_forced_into_base_prompt(self):
        ...
        expectations = (
            ("zh", "WAF 绕过", "工具使用"),
            ("en", "WAF Bypass", "Tool Usage"),
        )
        for lang, methodology_heading, core_heading in expectations:
            prompt = build_system_prompt(lang=lang)
            assert methodology_heading not in prompt
